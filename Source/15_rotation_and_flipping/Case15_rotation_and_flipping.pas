  ...
  begin
    ...
    try
      ...
      begin
        ...
        // Flip type
        flipType := TSDL_RendererFlags(SDL_FLIP_NONE);
        ...
        begin
          ...
          begin
            ...
            begin
              case e.key.keysym.sym of
                ...
                SDLK_a: degrees -= 60;
                SDLK_d: degrees += 60;
                sdlk_q: flipType := SDL_FLIP_HORIZONTAL;
                SDLK_w: flipType := SDL_FLIP_NONE;
                SDLK_e: flipType := SDL_FLIP_VERTICAL;
              end;
            end;
          end;
          ...
          gArrowTexture.Render((SCREEN_WIDTH - gArrowTexture.Width) div 2,
            (SCREEN_HEIGHT - gArrowTexture.Height) div 2, nil, degrees, nil, flipType);
...
const
  imgFoo = '../Source/15_rotation_and_flipping/arrow.png';
var
  success: boolean;
begin
  ...
  if not gArrowTexture.LoadFromFile(imgFoo) then
  begin
