unit Case32_text_input_and_clipboard_handling;
...
var
  ...
  // Scene texture
  gPromptTextTexture, gInputTextTexture: TTexture;
  gFont: PTTF_Font;
...
begin
  ...
  begin
    ...
    gInputTextTexture := TTexture.Create(gRenderer);
    try
      // Load media
      ...
      begin
        ...
        begin
          ...
          gInputTextTexture.Render((SCREEN_WIDTH - gInputTextTexture.GetWidth()) div 2,
...
const
  ttfLazy = '../Source/32_text_input_and_clipboard_handling/lazy.ttf';
var
  success: boolean;
  textColor: TSDL_Color;
begin
