unit Case25_capping_frame_rate;
...
const
  ...
  SCREEN_FPS = 60;
  SCREEN_TICKS_PER_FRAME = trunc(1000 / SCREEN_FPS);
...
var
  ...
  fpsTimer, capTimer: TTimer;
  avgFPS: Single;
  countedFrames, frameTicks: Integer;
begin
  ...
  begin
    gFPSTextTexture := TTexture.Create;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          timeText.Clear;
          timeText.Append('Average Frames Per Second ');
          timeText.Append(avgFPS);

          if not gFPSTextTexture.LoadFromRenderedText(timeText.ToString, textColor) then
          begin
          ...
          // Render textures
          gFPSTextTexture.Render((SCREEN_WIDTH - gFPSTextTexture.Width) div 2,
            gFPSTextTexture.Height div 2);
          ...
          if frameTicks < SCREEN_TICKS_PER_FRAME then
          begin
            // Wait remaining time
...
const
  ttfLazy = '../Source/25_capping_frame_rate/lazy.ttf';
var
  success: boolean;
begin
