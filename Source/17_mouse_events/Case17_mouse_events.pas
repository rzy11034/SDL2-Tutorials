    ...
    try
      ...
      begin
        ...
        begin
          ...
          gTextTexture.Render((SCREEN_WIDTH - gTextTexture.Width) div 2,
            (SCREEN_HEIGHT - gTextTexture.Height) div 2);
...
const
  ttfLazy = '../Source/16_true_type_fonts/lazy.ttf';
var
  success: boolean;
...
begin
  ...
  begin
    ...
    if not gTextTexture.LoadFromRenderedText
      ('The quick brown fox jumps over the lazy dog', textColor) then
    begin
